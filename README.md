...
| Anything else         | none                                                  | Says so plainly; you can still cut by hand                                                                             |
...
Windows will warn about an unknown publisher, because the builds are not signed with a paid
certificate.
